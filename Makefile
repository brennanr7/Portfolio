...
SixDegree_test: SixDegrees_tests.o SixDegrees.o CollabGraph.o Artist.o
	${CXX} -o $@ $^
...
providephase1:
	provide comp15 proj2phase1 SixDegrees.cpp SixDegrees.h \
			main.cpp README Makefile test.txt artists.txt CollabGraph.cpp \
			CollabGraph.h

providephase2:
	provide comp15 proj2phase2 SixDegrees.cpp SixDegrees.h \
			main.cpp README Makefile CollabGraph.h CollabGraph.cpp \
			test.txt wrongArt.txt noPath.txt commandFile.txt \
			artists.txt
