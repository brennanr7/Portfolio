* This program stores characters in a certain order. It imitates some functions of the C++ string demonstrated in both a dynamic array and doubly linked list (not circular).
